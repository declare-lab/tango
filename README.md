...
[Paper](https://declare-lab.net/assets/pdfs/tango-arxiv.pdf) | [Model](https://huggingface.co/declare-lab/tango) | [Website and Examples](https://tango-web.github.io/) | [More Examples](https://github.com/declare-lab/tango/blob/master/samples/README.md) | [~~Demo~~](https://github.com/declare-lab/tango#tango-text-to-audio-using-instruction-guided-diffusion)
...
@article{ghosal2023tango,
  ...
  author={Deepanway Ghosal, Navonil Majumder, Ambuj Mehrish, Soujanya Poria},
